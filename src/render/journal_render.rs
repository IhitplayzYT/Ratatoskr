...
use crate::{input::general_input::Input::parse_hex_color, model::{app::App::{App, EditorMode, JournalFocus, JournalMode, Vim_mode}, meta::Meta::MyColor}, render::general_render::Render::render_color_swatch};


pub fn render_journal(f: &mut Frame, area: Rect, app: &App) {
    if app.journal_ui.mode == JournalMode::Load {
        render_journal_list(f, area, app);
        return;
    }
